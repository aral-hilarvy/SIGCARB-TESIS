var formularioSieteValorEconomico = new Vue({
    el: "#formularioSieteValorEconomico",
    data: {
                ...
                fetch(this.uri + "respuesta_encuesta/registrar", {
                    ...
                    .then(response => {
                        ...
                        if ((i + 1) == $this.respuestas.length) {
                            window.location.href = $this.ubicacion + "html_Encuesta_Valor_Economico/Formulario_Encuesta_1_Parte_2_1.html";
                        }
                    });
            }
