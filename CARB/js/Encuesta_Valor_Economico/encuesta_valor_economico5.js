var formularioCincoValorEconomico = new Vue({
    el: "#formularioCincoValorEconomico",
    data: {
                ...
                fetch(this.uri + "respuesta_encuesta/registrar", {
                    ...
                    .then(response => {
                        ...
                        if ((i + 1) == $this.respuestas.length) {
                            window.location.href = $this.ubicacion + "html_Encuesta_Valor_Economico/Formulario_Encuesta_1_Parte_1_2.html";
                        }
                    });
            }
