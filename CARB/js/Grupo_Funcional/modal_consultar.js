var modal_consultar_GrupoFuncional = new Vue({
    el: "#modal_consultar_GrupoFuncional",
    data: {
    ...
    methods: {
        ...
        Consult: function () {
            ...
            if (validate) {
                ...
                window.location.href = 'Consultar_Grupos_Funcionales.html';
            }
        ...
        Validar() {
            if (this.id_EDGrupoFuncional < 1) {
                $("#Consult_GrupoFuncional").css("border-color", "#FF0000");
